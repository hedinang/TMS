          ...
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Tiềm năng phát triển</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Lợi nhuận hiện tại</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Doanh thu trong ngày</h6>
              </div>
            </div>
          </div>
          <div className="col-xl-3 col-sm-6 grid-margin stretch-card">
            <div className="card">
              <div className="card-body">
                ...
                <h6 className="text-muted font-weight-normal">Chi phí hiện tại</h6>
              </div>
            </div>
          </div>
        </div>
              ...
              <div className="card-body">
                ...
                <div className="aligner-wrapper">
                  ...
                  <div className="absolute center-content">
                    ...
                    <p className="text-small text-muted text-center mb-0">Tổng</p>
                  </div>
                </div>  
                <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                  <div className="text-md-center text-xl-left">
                    <h6 className="mb-1">Chuyển khoản</h6>
                ...
                <div className="bg-gray-dark d-flex d-md-block d-xl-flex flex-row py-3 px-4 px-md-3 px-xl-4 rounded mt-3">
                  <div className="text-md-center text-xl-left">
                    <h6 className="mb-1">Chuyển trực tiếp</h6>
                    <p className="text-muted mb-0">07 Jan 2019, 09:12AM</p>
                  </div>
                  <div className="align-self-center flex-grow text-right text-md-center text-xl-right py-md-2 py-xl-0">
            ...
            <div className="card">
              <div className="card-body">
                <div className="d-flex flex-row justify-content-between">
                  <h4 className="card-title mb-1">Hệ thống kho</h4>
                  <p className="text-muted mb-1">Trạng thái kho</p>
                </div>
                <div className="row">
                  <div className="col-12">
                    <div className="preview-list">
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Hà Nội</h6>
                            <p className="text-muted mb-0">50 cửa hàng</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">15 phút trước</p>
                            <p className="text-muted mb-0">30 cửa hàng đã mở</p>
                          </div>
                        </div>
                      </div>
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Thái Bình</h6>
                            <p className="text-muted mb-0">50 cửa hàng</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">1 giờ trước</p>
                            <p className="text-muted mb-0">23 cửa hàng đã mở</p>
                          </div>
                        </div>
                      </div>
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">TP Hồ Chí Minh</h6>
                            <p className="text-muted mb-0">50 cửa hàng</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">35 phút trước</p>
                            <p className="text-muted mb-0">15 cửa hàng đã mở</p>
                          </div>
                        </div>
                      </div>
                      <div className="preview-item border-bottom">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Bắc Ninh</h6>
                            <p className="text-muted mb-0">50 cửa hàng</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">55 phút trước</p>
                            <p className="text-muted mb-0">35 cửa hàng đã mở</p>
                          </div>
                        </div>
                      </div>
                      <div className="preview-item">
                        ...
                        <div className="preview-item-content d-sm-flex flex-grow">
                          <div className="flex-grow">
                            <h6 className="preview-subject">Nam Định</h6>
                            <p className="text-muted mb-0">50 cửa hàng</p>
                          </div>
                          <div className="mr-auto text-sm-right pt-2 pt-sm-0">
                            <p className="text-muted">50 phút trước</p>
                            <p className="text-muted mb-0">27 cửa hàng đã mở</p>
                          </div>
                        </div>
                      </div>
                    </div>
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-8 col-sm-12 col-xl-8 my-auto">
                    ...
                    <h6 className="text-muted font-weight-normal">11.38% Tháng trước</h6>
                  </div>
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-8 col-sm-12 col-xl-8 my-auto">
                    ...
                    <h6 className="text-muted font-weight-normal"> 9.61% Tháng trước</h6>
                  </div>
                  <div className="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
              ...
              <div className="card-body">
                ...
                <div className="row">
                  <div className="col-8 col-sm-12 col-xl-8 my-auto">
                    ...
                    <h6 className="text-muted font-weight-normal">2.27% Tháng trước</h6>
                  </div>
                  <div className="col-4 col-sm-12 col-xl-4 text-center text-xl-right">
                    ...
                    <div className="preview-item-content d-flex flex-grow">
                      <div className="flex-grow">
                        <div className="d-flex d-md-block d-xl-flex justify-content-between">
                          ...
                          <p className="text-muted text-small">5 phút trước</p>
                        </div>
                    ...
                    <div className="preview-item-content d-flex flex-grow">
                      <div className="flex-grow">
                        <div className="d-flex d-md-block d-xl-flex justify-content-between">
                          ...
                          <p className="text-muted text-small">10 phút trước</p>
                        </div>
                        <p className="text-muted">Well, it seems to be working now.</p>
                      </div>
                    </div>
